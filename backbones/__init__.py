...
from .iresnet import iresnet18se, iresnet34se, iresnet50se, iresnet100se
...
def get_model(name, **kwargs):
    ...
    if name == "r18":
        ...
        return iresnet18se(False, **kwargs)
    elif name == "r34se":
        return iresnet34se(False, **kwargs)
    elif name == "r50se":
        return iresnet50se(False, **kwargs)
    elif name == "r100se":
        return iresnet100se(False, **kwargs)
