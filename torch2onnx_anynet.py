...
if __name__ == '__main__':
    ...
    from backbones_anynet import get_model
    ...
    parser.add_argument('--anynet_type', type=str, default="prlsq", help='')
    ...
    anynet_params = ConfigParams(path=os.path.join("backbones_anynet", "AnyNetXf_200_SE", args.param+".param"))
    backbone_onnx = get_model(anynet_params, mode=args.anynet_type)
